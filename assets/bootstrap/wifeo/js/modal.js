...
var Modal = (function($) {
    ...
    var ClassName = {
        SCROLLBAR_MEASURER: "we-modal-scrollbar-measure",
        BACKDROP: "we-modal-backdrop",
        OPEN: "we-modal-open",
        FADE: "we-fade",
        SHOW: "we-show"
    };
    var Selector = {
        DIALOG: ".we-modal-dialog",
        DATA_TOGGLE: '[data-toggle="modal"]',
        DATA_DISMISS: '[data-dismiss="modal"]',
        FIXED_CONTENT:
            ".we-fixed-top, .we-fixed-bottom, .we-is-fixed, .we-sticky-top",
        STICKY_CONTENT: ".we-sticky-top",
        NAVBAR_TOGGLER: ".we-navbar-toggler"
        /**
         * ------------------------------------------------------------------------
         * Class Definition
         * ------------------------------------------------------------------------
