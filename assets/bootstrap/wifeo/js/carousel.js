...
var Carousel = (function($) {
    ...
    var ClassName = {
        ...
        ACTIVE: "we-active",
        SLIDE: "we-slide",
        RIGHT: "we-carousel-item-right",
        LEFT: "we-carousel-item-left",
        NEXT: "we-carousel-item-next",
        PREV: "we-carousel-item-prev",
        ITEM: "we-carousel-item"
    };
    var Selector = {
        ACTIVE: ".we-active",
        ACTIVE_ITEM: ".we-active.carousel-item",
        ITEM: ".we-carousel-item",
        NEXT_PREV: ".we-carousel-item-next, .we-carousel-item-prev",
        INDICATORS: ".we-carousel-indicators",
